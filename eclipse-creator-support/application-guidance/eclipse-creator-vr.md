...
| Button                                                                                                                                           | Menu                | Purpose                                                        |
|--------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|----------------------------------------------------------------|
| ![Eclipse Creator VR SOP Menu Icon](../_images/ec-vr-sop-menu-icon.png "Eclipse Creator VR SOP menu icon"){ width=80 height=80 }                 | SOP Interface       | Choose Collection/SOP, progress current SOP, view sync status. |
| ![Eclipse Creator VR Licence Menu Icon](../_images/ec-vr-licencing-menu-icon.png "Eclipse Creator VR licensing menu icon"){ width=80 height=80 } | Licensing Interface | Enter a licence, see licence state.                            |
| ![Eclipse Creator VR Settings Menu Icon](../_images/ec-vr-settings-menu-icon.png "Eclipse Creator VR settings menu icon"){ width=80 height=80 }  | Settings            | Customise the app experience.                                  |
...
| Button                                                                                                                                                | Function                                       |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|
| ![Eclipse Creator VR Replay Audio Icon](../_images/ec-vr-replay-audio-icon.png "Eclipse Creator VR replay TTS icon"){ width=80 height=80 }            | Replay Text to Voice readout for current step. |
| ![Eclipse Creator VR Go To Previous Step Icon](../_images/ec-vr-previous-step-icon.png "Eclipse Creator VR previous step icon"){ width=80 height=80 } | Navigate to the previous SOP Step.             |
| ![Eclipse Creator VR Go To Next Step Icon](../_images/ec-vr-next-step-icon.png "Eclipse Creator VR next step icon"){ width=80 height=80 }             | Navigate to the previous SOP Step.             |
| ![Eclipse Creator VR Complete Step Icon](../_images/ec-vr-complete-step-icon.png "Eclipse Creator complete step icon"){ width=80 height=80 }          | Complete current SOP Step.                     |

| Status                                                                                                                                                       | Meaning                                                                                  |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| ![Eclipse Creator VR Desktop Sync Online](../_images/ec-vr-desktop-sync-online.png "Eclipse Creator VR desktop sync online status"){ width=60 height=60 }    | The VR experience is synchronised to the desktop app and data can be transferred.        |
| ![Eclipse Creator VR Desktop Sync Offline](../_images/ec-vr-desktop-sync-offline.png "Eclipse Creator VR desktop sync offline status"){ width=60 height=60 } | The VR experience is not synchronised to the desktop app and data cannot be transferred. |
...
| Button                                                                                                                                                      | Function                                    |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| ![Eclipse Creator VR Recenter UI Icon](../_images/ec-vr-recenter-ui-icon.png "Eclipse Creator VR recenter UI icon"){ width=80 height=80 }                   | Recenter main interface to users' position. |
| ![Eclipse Creator VR Reset Orientation Icon](../_images/ec-vr-reset-orientation-icon.png "Eclipse Creator VR reset orientation icon"){ width=80 height=80 } | Center play area to users' position.        |
| ![Eclipse Creator VR Quit Icon](../_images/ec-vr-quit-icon.png "Eclipse Creator VR quit icon"){ width=80 height=80 }                                        | Quit app.                                   |
...
![Eclipse Creator VR Object Attachment](../_images/ec-vr-attachment.png "Eclipse Creator VR object attachment")
...
![Eclipse Creator VR Warning](../_images/ec-vr-warning.png "Eclipse Creator VR warning")
