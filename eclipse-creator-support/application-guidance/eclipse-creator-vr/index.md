...
| Button                                                                    | Menu                | Purpose                                                        |
|---------------------------------------------------------------------------|---------------------|----------------------------------------------------------------|
| <img src="https://support.fourplus.co.uk/wp-content/uploads/2026/02/ec-vr-sop-menu-icon.png" width="80" height="80">       | SOP Interface       | Choose Collection/SOP, progress current SOP, view sync status. |
| <img src="https://support.fourplus.co.uk/wp-content/uploads/2026/02/ec-vr-licencing-menu-icon.png" width="80" height="80"> | Licensing Interface | Enter a licence, see licence state.                            |
| <img src="https://support.fourplus.co.uk/wp-content/uploads/2026/02/ec-vr-settings-menu-icon.png" width="80" height="80">  | Settings            | Customise the app experience.                                  |
...
| Status                                                                                                                               | Meaning                                                                                  |
|--------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| ![Eclipse Creator VR Desktop Sync Online](/_images/ec-vr-desktop-sync-online.png "Eclipse Creator VR desktop sync online status")    | The VR experience is synchronised to the desktop app and data can be transferred.        |
| ![Eclipse Creator VR Desktop Sync Offline](/_images/ec-vr-desktop-sync-offline.png "Eclipse Creator VR desktop sync offline status") | The VR experience is not synchronised to the desktop app and data cannot be transferred. |
...
| Button                                                                                                                              | Function                                    |
|-------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| ![Eclipse Creator VR Recenter UI Icon](/_images/ec-vr-recenter-ui-icon.png "Eclipse Creator VR recenter UI icon")                   | Recenter main interface to users' position. |
| ![Eclipse Creator VR Reset Orientation Icon](/_images/ec-vr-reset-orientation-icon.png "Eclipse Creator VR reset orientation icon") | Center play area to users' position.        |
...
- Closed fist: pick up medium to large objects.
    ...
    - Index curl: while held, some objects can be controlled by moving the index finger, e.g. using spray bottle, or the sereological pipette controller.
