...
### I am connected to the institution's network, but the headset and desktop are not syncing: "Failed to sync and load cached data, loaded default SOP data."
...
Yes, you will need to connect to Wi-Fi on both devices to receive app updates.
...
No, however, you cannot edit SOPs and sync the changes to headset without a network connection.
...
### As an organisation with access to multiple headsets, what is the best way of downloading and managing applications onto this?

We recommend Meta for Business or the fleet system ArborXR. These both come with their unique differences and perks but overall allow you to manage your fleet of Meta Quests. Take control of your fleet, set up headsets quickly, configure settings and deploy apps. Find out more at [ArborXR](https://arborxr.com/) and [Meta](https://forwork.meta.com/gb/meta-horizon-managed-solutions/).
...
2. Use the official Meta MDM through Meta for Business and sign up as an organisation. This allows access to the official MDM features through a single organisation account. [Link Here](https://forwork.meta.com/gb/meta-horizon-managed-solutions/)
3. Use an external MDM like ArbourXR to manage your apps through a single external organisation account. [Link Here](https://arborxr.com/supported-devices/meta)
...
2. Before doing this, we recommend looking into Meta for Business. 
3. Login to your Meta account on PC, the mobile app and headset.
4. Download the apps from the Meta Horizon store.
5. Enter your unique licence key to experience the software.

### Where can I find my licence key for installation?

Licence keys are unique to each customer and will be sent via email. Under the licence agreement, these should not be shared outside the paying organisation. If you have lost or forgotten your licence key, contact our <admin@fourplus.co.uk> or sales team <sales@fourplus.co.uk> to receive it.

### I need more assistance with my Meta headset or Meta account.

If you are having technical issues unrelated to the FourPlus applications and related to Meta, then contact their help and advice team directly or visit their forum.

### How do I make use of the Meta Quests features e.g. casting?

Follow this [link](https://www.meta.com/en-gb/help/quest/562419235163295/) for headset feature support.

### How do I erase my saved Collections from my VR headset?

Uninstall the application and the data associated with it will be permanently deleted.

## Applications

### Can you toggle passthrough on and off in the FourPlus software?
